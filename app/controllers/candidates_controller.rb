...
class CandidatesController < ApplicationController
  ...
  def candidate_params
    params.require(:candidate).permit(:name, :email, :current_role, :applied_role, :location, :total_experience,
                                      :relevant_experience, :skills, :notice_period, :resume_link, :linkedin_link, :github_link, :repo_link, :company_name, :feedback, :offer_given)
  end
end
